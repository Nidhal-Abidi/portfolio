...
const INITIAL_CHOICES: Choice[] = [
  {
    ...
    response:
      "I'm Nidhal. I am a student at University of Passau studying Artificial Intelligence. I am currently working on few projects, including this one!",
  },
  {
    id: "hobbies",
...
export function ChatBot() {
  ...
  function removeElt(arr: Choice[], elt: Choice) {
  ...
  function getJokesAndCatFacts(source: CancelTokenSource) {
    Promise.all([
